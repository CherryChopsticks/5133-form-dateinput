"""
Django settings for mediamissing project.
...
ROOT_URLCONF = 'mediamissing.urls'
...
WSGI_APPLICATION = 'mediamissing.wsgi.application'
...
WAGTAIL_USER_CUSTOM_FIELDS = ['date_joined']


WAGTAIL_SITE_NAME = "mediamissing"
